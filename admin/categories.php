...
?>
	<tr height="25px">
		...
		<td align="center"><a href="?page=categoriesdelete&id=<? echo($row[$i][0]) ?>"  
					onClick="return confirm('Do you want to delete <? echo($row[$i][1]) ?> catogry?');"><img src="img/b_drop.png" width="16" height="16" /></a></td>
    </tr>
<?
	}
?>
