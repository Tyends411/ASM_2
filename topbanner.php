...
<!--<div class="logo">
<a href="index.php">
<img src="img/logo.jpg" /></a></div>-->
<div class="shoppingcart">

    <strong style="color: #3D24BA"><u><span class="glyphicon glyphicon-shopping-cart"></span>Shopping cart:</u></strong> <br />
    now in your cart: 
	...
	<? 
		if($_SESSION['sess_username'] != '') {
		    echo('<br /><font color="#CC0000">Welcome: <strong>' . $_SESSION['sess_username'] . 
                            '</strong></font><div class="logout"><a href="?page=logout&cart=' . $GLOBALS['cart'] . '">Logout</a></div>');
		}
